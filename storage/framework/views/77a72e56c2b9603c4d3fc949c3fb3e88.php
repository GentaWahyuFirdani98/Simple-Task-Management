<?php $__env->startSection('title', 'Dashboard DB Raw - Task Management'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600">Welcome back, <?php echo e(session('user_name')); ?>! <span class="text-red-600 font-medium">[Using Raw SQL]</span></p>
        </div>
        <div class="flex space-x-3">
            <a href="<?php echo e(route('tasks.create.raw')); ?>" class="btn-primary">
    ...
    <div class="card">
        ...
        <div class="flex flex-wrap gap-2">
            <a href="<?php echo e(route('dashboard.raw')); ?>" class="btn-secondary text-sm">All Tasks</a>
            <a href="<?php echo e(route('tasks.filter.raw', 'pending')); ?>" class="btn-warning text-sm">Pending</a>
            <a href="<?php echo e(route('tasks.filter.raw', 'in_progress')); ?>" class="btn-primary text-sm">In Progress</a>
            <a href="<?php echo e(route('tasks.filter.raw', 'completed')); ?>" class="btn-success text-sm">Completed</a>
        </div>
    </div>
                    ...
                    <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                        <div class="flex justify-between items-start">
                            ...
                            <div class="flex items-center space-x-2 ml-4">
                                <!-- Quick Status Update -->
                                <select class="status-select-raw form-select text-sm" data-task-id="<?php echo e($task->id); ?>">
                                ...
                                <!-- Action Buttons -->
                                <a href="<?php echo e(route('tasks.edit.raw', $task->id)); ?>" class="btn-secondary text-sm">
                                    Edit (Raw)
                                </a>
                                
                                <form method="POST" action="<?php echo e(route('tasks.destroy.raw', $task->id)); ?>" class="inline">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\whyuf\OneDrive\Dokumen\kuliah\PWEB\TUGAS\task-management\resources\views/dashboard-raw.blade.php ENDPATH**/ ?>